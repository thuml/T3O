...
def generate_latex_table(df, file_name='latex_table_perspective.tex'):
    with open(file_name, 'w') as f:
        ...
        for i, item in enumerate(models):
            ...
            if i == 0:
                f.write(
                    f'        \\multirow{{{len(models)}}}{{*}}{{\\textbf{{Model}}}} & {item} & {mse_mean:.2f}\\% & {mse_median:.2f}\\% & {mse_std:.2f}\\% & {mse_iqr:.2f}\\% \\\\\n')
            else:
                # 添加%符号在latex中
                f.write(
                    f'         & {item} & {mse_mean:.2f}\\% & {mse_median:.2f}\\% & {mse_std:.2f}\\% & {mse_iqr:.2f}\\% \\\\\n')
        f.write('        \\midrule\n')
        ...
        for i, item in enumerate(data_names):
            ...
            if i == 0:
                f.write(
                    f'        \\multirow{{{len(data_names)}}}{{*}}{{\\textbf{{Data}}}} & {item} & {mse_mean:.2f}\\% & {mse_median:.2f}\\% & {mse_std:.2f}\\% & {mse_iqr:.2f}\\% \\\\\n')
            else:
                f.write(
                    f'         & {item} & {mse_mean:.2f}\\% & {mse_median:.2f}\\% & {mse_std:.2f}\\% & {mse_iqr:.2f}\\% \\\\\n')
        f.write('        \\midrule\n')
        ...
        for i, item in enumerate(tasks):
            ...
            if i == 0:
                f.write(
                    f'        \\multirow{{{len(tasks)}}}{{*}}{{\\textbf{{Task}}}} & {item} & {mse_mean:.2f}\\% & {mse_median:.2f}\\% & {mse_std:.2f}\\% & {mse_iqr:.2f}\\% \\\\\n')
            else:
                f.write(
                    f'         & {item} & {mse_mean:.2f}\\% & {mse_median:.2f}\\% & {mse_std:.2f}\\% & {mse_iqr:.2f}\\% \\\\\n')
        ...
        f.write(f'        \\multicolumn{{2}}{{c|}}{{\\textbf{{Average}}}} & \\textbf{{{mse_mean:.2f}}}\\% & \\textbf{{{mse_median:.2f}}}\\% & \\textbf{{{mse_std:.2f}}}\\% & \\textbf{{{mse_iqr:.2f}}}\\% \\\\\n')
