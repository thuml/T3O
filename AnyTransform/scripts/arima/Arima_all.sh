...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "AnyTransform/scripts/arima/Arima-ECL.sh"
    "AnyTransform/scripts/arima/Arima-ETTh1.sh"
    "AnyTransform/scripts/arima/Arima-ETTh2.sh"
    "AnyTransform/scripts/arima/Arima-ETTm1.sh"
    "AnyTransform/scripts/arima/Arima-ETTm2.sh"
    "AnyTransform/scripts/arima/Arima-Exchange.sh"
    "AnyTransform/scripts/arima/Arima-Traffic.sh"
    "AnyTransform/scripts/arima/Arima-Weather.sh"
)
