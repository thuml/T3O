...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "AnyTransform/scripts/TimerXL/TimerXL_ECL.sh"
    "AnyTransform/scripts/TimerXL/TimerXL_ETTh1.sh"
    "AnyTransform/scripts/TimerXL/TimerXL_ETTh2.sh"
    "AnyTransform/scripts/TimerXL/TimerXL_ETTm1.sh"
    "AnyTransform/scripts/TimerXL/TimerXL_ETTm2.sh"
    "AnyTransform/scripts/TimerXL/TimerXL_Exchange.sh"
    "AnyTransform/scripts/TimerXL/TimerXL_Traffic.sh"
    "AnyTransform/scripts/TimerXL/TimerXL_Weather.sh"
)
